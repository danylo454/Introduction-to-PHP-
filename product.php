                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="images p-3">
                                <div class="text-center p-4">
                                    <img id="main-image" src="https://i.imgur.com/Dhebu4F.jpg" width="250"/></div>
                        ...
                        <div class="col-md-6">
                            <div class="product p-4">
                                ...
                                <div class="mt-4 mb-3">
                                    <h5 class="text-uppercase"><h5><?php echo $name; ?> </h5>
                                        <div class="price d-flex flex-row align-items-center"><span
                                                    class="act-price"><?php echo $price; ?> ₴</span>
                                        </div>
                                </div>
                                ...
                                <div class="sizes mt-5">
                                    ...
                                    </label> <label class="radio"> <input type="radio" name="size" value="XXL"> <span>XXL</span>
                                    </label>
                                </div>
